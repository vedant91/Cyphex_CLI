...
try:
    ...
    # terminal_ui/rich unavailable: take the same values straight from the
    # dependency-free palette so the mascot stays on-brand.
    from ui_palette import PHOS, PHOS_DIM, REF, CAUT, WARN_HOT, APEX, LABEL
